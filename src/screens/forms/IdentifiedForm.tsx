        ...
        <div className="card p-8">
          ...
          <div className="flex flex-col gap-4 max-h-[70vh] overflow-y-auto pr-2">
            <label className="text-[var(--midnight-violet)]">
              <span className="flex items-center gap-2">Código universitario <HelpTooltip content="Identificador UTP para dar seguimiento a tu caso." /></span>
            ...
            <div className="text-[var(--midnight-violet)]">
              ...
              <div className="mt-2 flex gap-3">
                <label className="flex items-center gap-2">
                  <input type="radio" name="witnesses-id" checked={hasWitnesses === "yes"} onChange={() => setHasWitnesses("yes")} /> Sí
                </label>
                <label className="flex items-center gap-2">
                  <input type="radio" name="witnesses-id" checked={hasWitnesses === "no"} onChange={() => setHasWitnesses("no")} /> No
                </label>
                <label className="flex items-center gap-2">
                  <input type="radio" name="witnesses-id" checked={hasWitnesses === "unknown"} onChange={() => setHasWitnesses("unknown")} /> No estoy seguro
                </label>
              </div>
            </div>
            <div className="text-[var(--midnight-violet)]">
